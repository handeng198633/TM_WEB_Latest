...
oPaginate:{sFirst:"首页",sLast:"末页",sNext:"后一页",sPrevious:"前一页"},sEmptyTable:"暂无数据",sInfo:"显示 _START_ to _END_ of _TOTAL_ 记录",sInfoEmpty:"显示 0 to 0 of 0 记录",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 记录",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
